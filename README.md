...
> 启动后打开 [http://127.0.0.1:8000/](http://127.0.0.1:8000/)，初始密码 `admin`（请先在「修改密码」页改掉）
...
| 部署 | Docker / Docker Compose / 单端口 8000 服务前端 SPA + API |
...
打开 [http://127.0.0.1:8000/](http://127.0.0.1:8000/) → 输入初始密码 `admin` → 进入 Dashboard。
